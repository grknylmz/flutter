...
/// An item in a menu created by a [FixedDropDownButton].
///
...
class FixDropdownMenuItem<T> extends StatelessWidget {
  ...
  ///
  /// Eventually returned in a call to [FixedDropDownButton.onChanged].
  final T value;
...
/// An inherited widget that causes any descendant [FixedDropDownButton]
/// widgets to not include their regular underline.
///
/// This is used by [DataTable] to remove the underline from any
/// [FixedDropDownButton] widgets placed within material data tables, as
...
class DropdownButtonHideUnderline extends InheritedWidget {
  ...
  /// Returns whether the underline of [FixedDropDownButton] widgets should
  /// be hidden.
...
class _DropdownButtonState<T> extends State<FixedDropDownButton<T>> with WidgetsBindingObserver {
  int _selectedIndex;
